...
exports.init = function(cli) {
        ...
        return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          return cli.interaction.promptIfNotGiven($("topology resource group : "), topologyResourceGroup, __cb(_, __frame, 3, 54, function ___(__0, __3) { options.topologyResourceGroup = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the network watcher \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__9() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__9() {
                        ...
                        return networkManagementClient.networkWatchers.get(resourceGroup, name, null, __cb(_, __frame, 12, 65, function ___(__0, __4) { networkWatcher = __4; __then(); }, true)); }); })(function ___(e, __result) { __catch(function __$__9() { if (e) {
                ...
                progress = cli.interaction.progress(util.format($("Performing get topology operation on a network watcher \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__9() {
                      ...
                      return networkManagementClient.networkWatchers.getTopology(resourceGroup, name, parameters, __cb(_, __frame, 34, 65, function ___(__0, __5) { networkWatcher = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__9() {
  ...
  networkWatchers.command("security-group-view [resource-group] [name] [target]").description($("Perform get vm security rules operation on a network watcher")).usage("[options] <resource-group> <name> <target>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the network watcher")).option("-t, --target <target>", $("id of the target VM")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __12(resourceGroup, name, target, options, _) { var subscription, networkManagementClient, networkWatcher, progress, parameters; var __frame = { name: "__12", line: 667 }; return __func(_, this, arguments, __12, 4, __frame, function __$__12() {
